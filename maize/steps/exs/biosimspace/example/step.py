...
# TODO: Create BioSimSpaceNode base class?


class Parameterise(Node): ...


class Solvate(Node): ...


class _MinimiseBase(Node): ...


class MinimiseAmber(_MinimiseBase): ...


class MinimiseGromacs(_MinimiseBase): ...


class _EquilibrateBase(Node): ...


class EquilibrateAmber(_EquilibrateBase): ...


class EquilibrateGromacs(_EquilibrateBase): ...


class _ProductionBase(Node): ...


class ProductionAmber(_ProductionBase): ...


class ProductionGromacs(_ProductionBase): ...


class ProductionOpenMM(_ProductionBase): ...


class _RbfeBase(Node): ...


class RbfeGromacs(_RbfeBase): ...


class RbfeSOMD(_RbfeBase): ...


class _AbfeBase(Node): ...


class AbfeGromacs(_AbfeBase): ...


class AbfeSOMD(_AbfeBase): ...
